...
models = [PPO(MlpPolicy, env, verbose=0, gamma=0.999, batch_size=512, n_steps=1, ent_coef=0.000001, learning_rate=0.00001, vf_coef=0.5, max_grad_norm=0.5, gae_lambda=0.95) for env in envs]
